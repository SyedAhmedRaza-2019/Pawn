...
public logevent_round_start()
{
	...
	for(new i = 0, iplayer; i < pnum; i++)
	{
		...
		{
			client_print_color(iplayer, print_team_default, "%s^3 Menu is^4 Closed^3 by Admin Please Contact Admins",PREFIX_CHAT);
			return PLUGIN_CONTINUE
		}
		if (get_pcvar_num(g_menu_active)&&(g_round<availableRound))
		{
			client_print_color(iplayer, print_team_default, "%s^3 Menu Will be Active From^4 %i^3 Round",PREFIX_CHAT,availableRound);
		}
